...
export class CytoScapeNodeAttributesModel extends CytoScapeCommonAttributesModel {
  static defineSchema() {
    ...
    return {
      ...
      "background-image-crossorigin": new fields.StringField({
        required: false,
        blank: true,
        initial: "anonymous",
      }),
      // Transparenz des Hintergrundbildes
      "background-image-opacity": new fields.NumberField({
        required: false,
        blank: true,
        initial: 1,
      }),
      // Begrenzung des Bildes (inside, outside)
      "background-image-containment": new fields.StringField({
        required: false,
        blank: true,
        initial: "inside",
      }),
      // Bildglättung (yes, no)
      "background-image-smoothing": new fields.StringField({
        required: false,
        blank: true,
        initial: "yes",
      }),
      // Horizontale Bildposition (50%, left, center, right)
      "background-position-x": new fields.StringField({
        required: false,
        blank: true,
        initial: "50%",
      }),
      // Vertikale Bildposition (50%, top, center, bottom)
      "background-position-y": new fields.StringField({
        required: false,
        blank: true,
        initial: "50%",
      }),
      ...
      "background-width-relative-to": new fields.StringField({
        required: false,
        blank: true,
        initial: "include-padding",
      }),
      // Relative Bildhöhe (include-padding, exclude-padding)
      "background-height-relative-to": new fields.StringField({
        required: false,
        blank: true,
        initial: "include-padding",
      }),
      // Bild-Wiederholung (no-repeat, repeat, repeat-x, repeat-y)
      "background-repeat": new fields.StringField({
        required: false,
        blank: true,
        initial: "no-repeat",
      }),
      ...
      "background-height": new fields.StringField({
        required: false,
        blank: true,
        initial: "auto",
      }),
      ...
      "border-dash-pattern": new fields.ArrayField(new fields.NumberField(), {
        required: false,
        blank: true,
        initial: [4, 2],
      }),
      ...
      "border-position": new fields.StringField({
        required: false,
        blank: true,
        initial: "center",
      }),
      ...
      "background-gradient-direction": new fields.StringField({
        required: false,
        blank: true,
        initial: "to-bottom",
      }),
      // Gradient-Farben (#ff0000, #00ff00, #0000ff)
      "background-gradient-stop-colors": new fields.StringField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      // Gradient-Positionen (0%, 50%, 100%)
      "background-gradient-stop-positions": new fields.StringField({
        required: false,
        blank: true,
        initial: "0%",
      }),
      ...
      "shape-polygon-points": new fields.StringField({
        required: false,
        blank: true,
      ...
      "padding-relative-to": new fields.StringField({
        required: false,
        blank: true,
        initial: "width",
      }),
      ...
      "compound-sizing-wrt-labels": new fields.StringField({
        required: false,
        blank: true,
        initial: "include",
      }),
