...
export class CytoScapeEdgeAttributesModel extends CytoScapeCommonAttributesModel {
  static defineSchema() {
    ...
    return {
      ...
      "target-arrow-shape": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
      // Pfeilfarbe am Ende
      "target-arrow-color": new fields.ColorField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      ...
      "target-arrow-fill": new fields.StringField({
        required: false,
        blank: true,
        initial: "filled",
      }),
      // Pfeilform am Anfang (none, triangle, vee, tee, diamond, square)
      "source-arrow-shape": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
      // Pfeilfarbe am Anfang
      "source-arrow-color": new fields.ColorField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      ...
      "source-arrow-fill": new fields.StringField({
        required: false,
        blank: true,
        initial: "filled",
      }),
      // Mittlerer Pfeil am Anfang (none, triangle, vee, tee, diamond, square)
      "mid-source-arrow-shape": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
      // Mittlerer Pfeilfarbe am Anfang
      "mid-source-arrow-color": new fields.ColorField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      // Mittlerer Pfeilbreite am Anfang
      "mid-source-arrow-width": new fields.NumberField({
        required: false,
        blank: true,
        initial: 1,
      }),
      // Mittlerer Pfeilfüllung am Anfang (filled, hollow)
      "mid-source-arrow-fill": new fields.StringField({
        required: false,
        blank: true,
        initial: "filled",
      }),
      // Mittlerer Pfeil am Ende (none, triangle, vee, tee, diamond, square)
      "mid-target-arrow-shape": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
      // Mittlerer Pfeilfarbe am Ende
      "mid-target-arrow-color": new fields.ColorField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      // Mittlerer Pfeilbreite am Ende
      "mid-target-arrow-width": new fields.NumberField({
        required: false,
        blank: true,
        initial: 1,
      }),
      // Mittlerer Pfeilfüllung am Ende (filled, hollow)
      "mid-target-arrow-fill": new fields.StringField({
        required: false,
        blank: true,
        initial: "filled",
      }),
      ...
      // Linienumrissfarbe
      "line-outline-color": new fields.ColorField({
        required: false,
        blank: true,
        initial: "#000",
      }),
      // Linien-Gradient-Farben
      "line-gradient-stop-colors": new fields.StringField({
        required: false,
        blank: true,
        initial: "#999",
      }),
      // Linien-Gradient-Positionen
      "line-gradient-stop-positions": new fields.StringField({
        required: false,
        blank: true,
        initial: "0%",
      }),
      // Strichmuster für gestrichelte Linien
      "line-dash-pattern": new fields.ArrayField(new fields.NumberField(), {
        required: false,
        blank: true,
        initial: [6, 3],
      }),
      ...
      "control-point-step-size": new fields.NumberField({
        required: false,
        blank: true,
        initial: 40,
      }),
      // Kontrollpunkt-Gewichtung (0-1)
      "control-point-weights": new fields.NumberField({
        required: false,
        blank: true,
        initial: 0.5,
      }),
      ...
      "radius-type": new fields.StringField({
        required: false,
        blank: true,
        initial: "arc-radius",
      }),
      ...
      "taxi-turn-min-distance": new fields.NumberField({
        required: false,
        blank: true,
        initial: 10,
      }),
      ...
      "edge-distances": new fields.StringField({
        required: false,
        blank: true,
      ...
      "source-distance-from-node": new fields.NumberField({
        required: false,
        blank: true,
        initial: 0,
      }),
      // Ziel-Distanz vom Node in Pixeln
      "target-distance-from-node": new fields.NumberField({
        required: false,
        blank: true,
        initial: 0,
      }),
      // Quell-Endpunkt (outside-to-node, outside-to-line, inside-to-node)
      "source-endpoint": new fields.StringField({
        required: false,
        blank: true,
        initial: "outside-to-node",
      }),
      // Ziel-Endpunkt (outside-to-node, outside-to-line, inside-to-node)
      "target-endpoint": new fields.StringField({
        required: false,
        blank: true,
        initial: "outside-to-node",
      }),
      ...
      "source-text-rotation": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
      ...
      "target-text-rotation": new fields.StringField({
        required: false,
        blank: true,
        initial: "none",
      }),
